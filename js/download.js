...
//    if( (nxtySwVerNuSCfgCld != swVerNoCldText) && (nxtySwVerNuSCfg.localeCompare(nxtySwVerNuSCfgCld) == -1) )
    if( (nxtySwVerNuSCfgCld != swVerNoCldText) && (nxtySwVerNuSCfg != nxtySwVerNuSCfgCld) )
    {
        bNuSCfgUpdate = true;
...
//    if( (nxtySwVerNuUCfgCld != swVerNoCldText) && (nxtySwVerNuUCfg.localeCompare(nxtySwVerNuUCfgCld) == -1) )
    if( (nxtySwVerNuUCfgCld != swVerNoCldText) && (nxtySwVerNuUCfg != nxtySwVerNuUCfgCld) )
    {
        bNuUCfgUpdate = true;
...
//    if( (nxtySwVerNuArtCld != swVerNoCldText) && (nxtySwVerNuArt.localeCompare(nxtySwVerNuArtCld) == -1) )
    if( (nxtySwVerNuArtCld != swVerNoCldText) && (nxtySwVerNuArt != nxtySwVerNuArtCld) )
    {
        bNuArtUpdate = true;
...
//    if( (nxtySwVerNuEvmCld != swVerNoCldText) && (nxtySwVerNuEvm.localeCompare(nxtySwVerNuEvmCld) == -1) )
    if( (nxtySwVerNuEvmCld != swVerNoCldText) && (nxtySwVerNuEvm != nxtySwVerNuEvmCld) )
    {
        bNuEvmUpdate = true;
...
//    if( (nxtySwVerCuArtCld != swVerNoCldText) && (nxtySwVerCuArt.localeCompare(nxtySwVerCuArtCld) == -1) )
    if( (nxtySwVerCuArtCld != swVerNoCldText) && (nxtySwVerCuArt != nxtySwVerCuArtCld) )
    {
        bCuArtUpdate = true;
...
//    if( (nxtySwVerCuBtCld != swVerNoCldText) && (nxtySwVerCuBt.localeCompare(nxtySwVerCuBtCld) == -1) )
    if( (nxtySwVerCuBtCld != swVerNoCldText) && (nxtySwVerCuBt != nxtySwVerCuBtCld) )
    {
        bBtUpdate = true;
...
//                    ShowWaitPopUpMsg( "Please wait", infoText );
    ...
    {    
        ...
        else
        {
            ...
            guiSwCelFiVers[0] = nxtySwVerNuUCfg;
            guiSwCelFiVers[1] = nxtySwVerNuArt;
            guiSwCelFiVers[2] = nxtySwVerNuEvm;
            guiSwCelFiVers[3] = nxtySwVerNuPic;
            guiSwCelFiVers[4] = nxtySwVerNuSCfg;
            guiSwCelFiVers[5] = nxtySwVerNuCf;
            guiSwCelFiVers[6] = nxtySwVerCuArt;
            guiSwCelFiVers[7] = nxtySwVerCuBt;
            guiSwCelFiVers[8] = nxtySwVerCuPic;
            guiSwCelFiVers[9] = nxtySwVerCuCf;
        }
    ...
    switch( DldState )
    {
        ...
        case DLD_STATE_INIT:
        {
            ...
            if( nxtyRxStatusIcd <= V1_ICD )
            {
                ...
                guiSwCldVers[0] = nxtySwVerNuUCfgCld;
                guiSwCldVers[1] = nxtySwVerNuArtCld;
                guiSwCldVers[2] = nxtySwVerNuEvmCld;
                guiSwCldVers[3] = nxtySwVerNuPicCld;
                guiSwCldVers[4] = nxtySwVerNuSCfgCld;
                guiSwCldVers[5] = nxtySwVerNuCfCld;
                guiSwCldVers[6] = nxtySwVerCuArtCld;
                guiSwCldVers[7] = nxtySwVerCuBtCld;
                guiSwCldVers[8] = nxtySwVerCuPicCld;
                guiSwCldVers[9] = nxtySwVerCuCfCld;
                ...
                guiSwStatus[5] = (bNuCfUpdate)?"0%":"OK";
                guiSwStatus[6] = (bCuArtUpdate)?"0%":"OK";
                guiSwStatus[7] = (bBtUpdate)?"0%":"OK";
...
//                DldTimeoutCount             = 0;
                ...
                if( DldOrderArray[currentDldIndex] == DLD_NU_SCFG)
                {
                    ...
                    GetNxtyConfigFile(nxtyNuUniqueId, newOperatorSku);
                }
                else
                { 
